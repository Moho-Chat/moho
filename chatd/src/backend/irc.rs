        ...
        async move {
            ...
            match result {
                ...
                Err(_) => {
                    ...
                    state.runtime.finish_connection(&state, &account_id, generation, ConnState::Disconnected, Some("internal error (see chatd logs)"));
                }
            }
        }
    });
...
async fn handle_message(
    ...
    match msg.command {
        ...
        // chatd_buffer_kind) - libpurple's own irc_msg_default() fallback
...
/// PRIVMSG. Mirrors daemon/chatd/actions.c's chatd_send_message, minus
