...
/// IRC account shape - mirrors daemon/chatd/actions.h's ChatdAccountOptions
...
/// Account/credential persistence at ~/.config/moho/accounts.toml,
...
impl AccountStore {
    ...
    /// (matches chatd_account_create()'s dedup behavior).
    ...
    /// convention chatd_set_account_sasl() uses (the frontend never reads
