...
/// (purple_accounts_get_all()/purple_get_conversations()) that chatd's C
...
impl Runtime {
    ...
    pub fn record_message(
        ...
        // always falls back to chatd's own generated one - but Discord's
        ...
        // daemon/chatd/uiops_conv.c's should_notify/is_highlight split).
